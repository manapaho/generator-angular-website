...
(function () {
  ...
  angular.module('app.home').factory('app.home.homeDataService', HomeDataFactory);

  // Inject the dependencies.
  HomeDataFactory.$inject = ['$q', '$http', 'app.core.service'];
   ...
   */
  function HomeDataFactory($q, $http, coreService) {
    // Create the service.
    var service = {
      getStuff: getStuff
    };
