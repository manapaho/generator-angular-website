...
module.exports = function makeWebpackConfig(options) {
  ...
  config.devServer = {
    ...
    /**
     * Uncomment the following lines to add your https certificates.
     * Then add --https to the dev script parameters to serve the site as https.
     */
    //,
    //cert: fs.readFileSync('certificates/whitelabel-dev.com.crt'),
    //key: fs.readFileSync('certificates/whitelabel-dev.com.decrypted.key')
  };
